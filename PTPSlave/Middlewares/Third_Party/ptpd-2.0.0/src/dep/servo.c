...
#define EXPONENCIAL_FILTER 	1
#define SLIDING_FILTER		2
#define MEAN_FILTER			3
#define KALMAN_FILTER		4

#define FILTER_TYPE EXPONENCIAL_FILTER

/* Exponencial smoothing */
//static void filter(int32_t * nsec_current, Filter * filt)
//{
//#if FILTER_TYPE == EXPONENCIAL_FILTER
//	int32_t s, s2;
//
//	/*
...
//#endif
//
//#if FILTER_TYPE == SLIDING_FILTER
//	static int32_t fil_wind[5] = {0,0,0,0,0};
//	static uint8_t ptr = 0;
//	int32_t sum = 0;
//	
//	fil_wind[ptr] = *nsec_current;
//	ptr++;
//	ptr%=5;
//	for(int i=0;i<5;i++){
//	  	sum += fil_wind[i];
...
//	*nsec_current = (int32_t)(((1-1/((float)cnt))*(float)prev_out)+1/((float)cnt)*(float)(*nsec_current));
//	cnt++;
//	prev_out = *nsec_current;
//#endif
//
