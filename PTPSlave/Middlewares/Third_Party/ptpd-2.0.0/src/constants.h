...
#define DEFAULT_INBOUND_LATENCY         0       /* in nsec */	//	入站延迟
#define DEFAULT_OUTBOUND_LATENCY        0       /* in nsec */	//	出站延迟
#define DEFAULT_NO_RESET_CLOCK          FALSE
#define DEFAULT_DOMAIN_NUMBER           0
#define DEFAULT_DELAY_MECHANISM         E2E
#define DEFAULT_AP                      0.6f			//PI调节器的Kp
#define DEFAULT_AI                      0.06f			//PI调节器的Ki
